...
for i = 1: get_n_samples
    ...
    if length(mqttMsg.Data) >= 3
        ...
        %   CONFIDENCE WEIGHTED AVERAGING
            ...
            var_x1(i) = temperature_1_variance;
            var_x2(i) = temperature_2_variance;
            var_x3(i) = temperature_3_variance;

            fused_signal(i) = (x1(i)*(1/var_x1(i))  +   x2(i)*(1/var_x2(i)))/ ((1/var_x1(i))  + (1/var_x2(i)));
...
% create plot for fused signal
fused_signal_plot = figure;
xlabel('sample [-]')
ylabel('temperature [°C]')
hold on
grid on
